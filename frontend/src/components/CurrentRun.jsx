  ...
  if (!currentRun) {
    return (
      <div className="bg-slate-800 rounded-lg p-6">
        ...
        <p className="text-slate-400">No token launched yet.</p>
      </div>
    );
  }
    ...
    <div className="bg-slate-800 rounded-lg p-6">
      ...
      <div className="space-y-4">
        <div className="bg-slate-700 rounded-lg p-4">
          <p className="text-sm text-slate-300 mb-1">Mint Address</p>
          <p className="text-sm font-mono text-white break-all">{currentRun.mintAddress || 'N/A'}</p>
        </div>

        <div className="bg-slate-700 rounded-lg p-4">
          <p className="text-sm text-slate-300 mb-1">Launch Status</p>
          <p className="text-lg font-bold text-white">{currentRun.launchStatus || 'N/A'}</p>
        </div>

        <div className="bg-slate-700 rounded-lg p-4">
          <p className="text-sm text-slate-300 mb-1">Wallet Count</p>
        ...
        {currentRun.timestamp && (
          <div className="bg-slate-700 rounded-lg p-4">
            <p className="text-sm text-slate-300 mb-1">Launch Time</p>
        ...
        {currentRun.bundleWalletsUsed && (
          <div className="bg-slate-700 rounded-lg p-4">
            <p className="text-sm text-slate-300 mb-1">Bundle Wallets</p>
        ...
        {currentRun.holderWalletKeys && (
          <div className="bg-slate-700 rounded-lg p-4">
            <p className="text-sm text-slate-300 mb-1">Holder Wallets</p>
